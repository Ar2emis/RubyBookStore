...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: 'div', class: 'form-group mb-30', error_class: 'has-error', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    ...
    b.optional :readonly
    b.use :label
    b.use :input, class: 'form-control', error_class: 'has-error', valid_class: 'is-valid'
